...
const Communicator = __importStar(require("./components/communicator"));
const version_1 = require("./version");
const utils_1 = require("./core/util/utils");
class MWPClient {
    constructor({ metadata, wallet }) {
        var _a, _b;
        this.metadata = Object.assign(Object.assign({}, metadata), { appName: metadata.appName || 'Dapp', appDeeplinkUrl: (0, utils_1.appendMWPResponsePath)(metadata.appDeeplinkUrl), appCustomScheme: metadata.appCustomScheme
                ? (0, utils_1.appendMWPResponsePath)(metadata.appCustomScheme)
                : undefined });
        this.wallet = wallet;
        ...
        this.accounts = [];
        this.chain = {
            id: (_b = (_a = metadata.appChainIds) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : 1,
        };
    ...
    async handshake() {
        ...
        const response = await Communicator.postRequestToWallet(handshakeMessage, this.wallet);
